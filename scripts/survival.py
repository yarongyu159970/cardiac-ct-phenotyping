...
FORMULAS = {
    "A": "age + C(gender) + SBP + C(Anti2) + TC + HDL + C(smoking) + C(DM)",
    "B": "age + C(gender) + SBP + C(Anti2) + TC + HDL + C(smoking) + C(DM) + C(CADRADS)",
    "C": "age + C(gender) + SBP + C(Anti2) + TC + HDL + C(smoking) + C(DM) + C(CADRADS) + C(Cluster)",
}
REQUIRED_COLUMNS = ["ID", "TIME", "MACST", "age", "gender", "SBP", "Anti2", "TC", "HDL", "smoking", "DM", "CAD-RADS"]
NUMERIC_COLUMNS = ["TIME", "MACST", "age", "SBP", "TC", "HDL", "CAD-RADS", "Cluster"]
